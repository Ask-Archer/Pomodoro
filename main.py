...
def start_timer():
    ...
    if reps % 8 == 0:
        ...
        timer.config(text = "Long Break Time!", fg= RED, font = (FONT_NAME, 50))
    elif reps % 2 == 0:
        count_down(short_break_sec)
        timer.config(text="Short Break", fg=PINK, font=(FONT_NAME, 50))
    else:
        count_down(work_sec)
        timer.config(text="Work", fg= GREEN, font = (FONT_NAME, 50))
